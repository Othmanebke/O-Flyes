  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="glass rounded-2xl p-8 w-full max-w-md">
        ...
        <h1 className="text-2xl font-bold mb-1 text-center">Connexion</h1>
        <p className="text-gray-400 text-sm text-center mb-6">Content de vous revoir !</p>
        ...
        <a
          ...
          className="w-full flex items-center justify-center gap-3 py-3 border border-gray-700 rounded-xl text-sm font-medium text-gray-300 hover:border-gray-400 transition-colors"
        >
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          ...
          <Link href="/auth/register" className="text-brand-400 hover:underline">S'inscrire</Link>
        </p>
      </div>
    </div>
  );
