...
import { Search, MapPin, Star, ArrowRight, Sparkles, Compass, Plus } from "lucide-react";
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="max-w-3xl mx-auto">
                        <form onSubmit={handleSearch} className="relative">
                            <div className="flex flex-col md:flex-row gap-0 bg-[#0A0D14] border border-white/10 rounded-[28px] shadow-[0_30px_80px_rgba(0,0,0,0.6)] overflow-hidden">
                                ...
                                <button type="submit" className="bg-gold text-[#0A0D14] font-black px-10 py-4 sm:py-5 m-2 rounded-[20px] hover:bg-yellow-400 transition-all flex items-center justify-center gap-2 text-xs uppercase tracking-widest shrink-0">
                        ...
                        {activities.map((activity, idx) => (
                            ...
                            >
                                <div className="relative h-56 overflow-hidden">
                                    ...
                                    <img src={AIVANA_PLACEHOLDER_IMG} alt={activity.title}
