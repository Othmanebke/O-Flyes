            ...
            <div className="relative h-[70vh] min-h-[500px] overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 z-20 translate-y-1/2 px-6">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="max-w-5xl mx-auto">
                        <form onSubmit={handleSearch} className="relative flex flex-col md:flex-row gap-0 bg-[#141822] border border-white/10 rounded-[28px] shadow-[0_30px_80px_rgba(0,0,0,0.6)] overflow-hidden backdrop-blur-2xl">
