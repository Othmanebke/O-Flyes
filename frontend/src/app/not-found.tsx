    ...
    return (
        <div className="min-h-screen bg-[#f9f7f4] flex flex-col items-center justify-center px-6 py-20 relative overflow-hidden">
            ...
            {["✦", "✦", "✦", "✦"].map((s, i) => (
                <div
                    key={i}
                    className="absolute text-gold-400/20 text-2xl font-bold animate-pulse"
                    style={{
                        top: `${[15, 70, 30, 80][i]}%`,
                        left: `${[10, 85, 60, 25][i]}%`,
            ...
            <div className="relative z-10 text-center max-w-lg">
                ...
                <Link href="/" className="inline-flex items-center gap-2 mb-12">
                    <div className="w-9 h-9 bg-dark-900 rounded-xl flex items-center justify-center">
                        <Plane className="w-4.5 h-4.5 text-white -rotate-45" />
                    </div>
                    <span className="font-serif text-2xl text-dark-900">
                        AI<span className="text-gold-500">VANA</span>
                    </span>
                </Link>

                {/* 404 big number */}
                <div className="relative mb-6">
                    <p className="font-serif text-[120px] md:text-[160px] leading-none text-dark-900/[0.06] font-bold select-none absolute inset-x-0 top-0 -translate-y-4">
                        404
                    </p>
                    <div className="relative pt-8">
                        <div className="w-20 h-20 bg-gold-50 border-2 border-gold-200 rounded-3xl flex items-center justify-center mx-auto mb-6 rotate-3 hover:rotate-6 transition-transform duration-300 cursor-default">
                            <Compass className="w-10 h-10 text-gold-500" />
                        </div>
                    </div>
                </div>

                <h1 className="font-serif text-4xl md:text-5xl text-dark-900 mb-4 leading-tight">
                    Page introuvable
                </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-12">
                    <Link href="/"
                        className="flex items-center gap-2 bg-dark-900 hover:bg-dark-800 text-white font-semibold text-sm px-6 py-3 rounded-xl transition-all hover:scale-105">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 text-xs text-gray-400">
                    {[
                        ...
                        <Link key={href} href={href} className="hover:text-dark-700 underline underline-offset-2 transition-colors">
                            {label}
                        </Link>
                    ))}
                </div>
